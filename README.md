...
Основные сущности:
1. **Пользователи (users):** данные о каждом пользователе.
2. **Задачи (tasks):** данные о задачах.
3. **Время (entries_time):** данные о потраченном на задачу времени.
4. **Предполагаемое время (estimated_time):** данные о предполагаемом для задачи времени.
